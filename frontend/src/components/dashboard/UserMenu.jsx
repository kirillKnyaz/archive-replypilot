...
function UserMenu() {
  ...
  return (<div>
    ...
    >
      ...
      <Link className='w-100 menu-link p-1 ps-4 m-0 text-decoration-none text-dark' to={"/queue"}>Action queue</Link>
      <Link className='w-100 menu-link p-1 ps-4 m-0 text-decoration-none text-dark' to={"/settings"}>Settings</Link>
